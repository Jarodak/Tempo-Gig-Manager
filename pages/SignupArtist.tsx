      ...
      <main className="flex-1 overflow-y-auto px-6 pb-8 space-y-6 hide-scrollbar">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full h-14 bg-surface-dark border border-white/10 rounded-xl px-4 font-medium outline-none focus:border-accent-cyan" placeholder="Create a password" />
          ...
          <div>
            ...
            <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full h-14 bg-surface-dark border border-white/10 rounded-xl px-4 font-medium outline-none focus:border-accent-cyan" placeholder="Repeat password" />

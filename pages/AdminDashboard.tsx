        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'users' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={loadUsers} className="text-sm text-primary font-bold hover:text-primary/80">Refresh</button>
                </div>
            ...
            {activeTab === 'venues' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold">Venues ({venues.length})</h3>
                  <button onClick={loadVenues} className="text-sm text-primary font-bold hover:text-primary/80">Refresh</button>
                </div>
                <div className="bg-surface-dark rounded-2xl border border-white/5 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-white/5">
                        {venues.map((venue) => (
                          <tr key={venue.id} className="hover:bg-white/5">
                            ...
                            <td className="px-4 py-3">
                              <button onClick={() => handleDelete('venues', venue.id)} className="text-red-500 hover:text-red-400 font-bold text-xs">Delete</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
            ...
            {activeTab === 'artists' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold">Artists ({artists.length})</h3>
                  <button onClick={loadArtists} className="text-sm text-primary font-bold hover:text-primary/80">Refresh</button>
                </div>
                <div className="bg-surface-dark rounded-2xl border border-white/5 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-white/5">
                        {artists.map((artist) => (
                          <tr key={artist.id} className="hover:bg-white/5">
                            ...
                            <td className="px-4 py-3">
                              <button onClick={() => handleDelete('artists', artist.id)} className="text-red-500 hover:text-red-400 font-bold text-xs">Delete</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
            ...
            {activeTab === 'gigs' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold">Gigs ({gigs.length})</h3>
                  <button onClick={loadGigs} className="text-sm text-primary font-bold hover:text-primary/80">Refresh</button>
                </div>
                <div className="bg-surface-dark rounded-2xl border border-white/5 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-white/5">
                        {gigs.map((gig) => (
                          <tr key={gig.id} className="hover:bg-white/5">
                            ...
                            <td className="px-4 py-3">
                              <button onClick={() => handleDelete('gigs', gig.id)} className="text-red-500 hover:text-red-400 font-bold text-xs">Delete</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
